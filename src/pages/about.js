...
const About = ({data}) => {
    ...
    return (<Layout>
        ...
        <section className="about-page">
            ...
            <p>I love using React and the framework it comes with. I combine this with Gatsby and its eco-system to create blazing-fast web content.</p>
            <p>I like to strike a good balance by creating a nice clean design that compliments the brand and content, and to make the content load super-fast. This is why I use Gatsby as apposed to other web development eco systems such as WordPress and Drupal.</p>
