...
const MissionStatement = () => {
    ...
    <p>I concentrate on building websites that offer the best user experience (UX) by making the website design blazing-fast and making it responsive to all screen sizes.</p>
